...
options2 = ["Scan", "SwipeCard", "FlushLeaves", "FixMeltdown", "InsertCode"]
...
def show_impostor(text):
    impostor_label = ctk.CTkLabel(root, text=text, font=("Arial",30), text_color="#4D4D4D", fg_color="white")
    my_canvas.create_window(850, 230, window=impostor_label, anchor="w",tags="sentence_widgets")
def build_design():
    init_ctk()
    recurrent_design()
    root.mainloop()
